...
const Tabble = ({ item, index1 }) => {
    ...
    const handleSubmitButton = async (e) => {
        ...
        const result = await axios.put("https://kba-iiti-1.onrender.com/index/edit_sri", {id:item._id,data:editData});
    ...
    const handleDelete = async (e)=>{
        e.preventDefault();
        const result = await axios.put("https://kba-iiti-1.onrender.com/index/delete_sri", {id:item._id});
