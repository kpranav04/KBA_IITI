...
const AppWithFilter = () => {
  ...
  const handleFilteEffect = async () => {
    ...
    const date = "";
    const Index = "";
    const res = await axios.post("https://kba-iiti-api.vercel.app/index/filters_spi", {
      location: location,
      date: date,
      Index: Index,
    });
  ...
  return (
    ...
    <h1 className="text-2xl font-bold mb-4" style={{color:"white",fontWeight:"bold"}}>Standardized Precipitation Index (SPI)</h1>
