...
const Tabble = ({ item, index1 }) => {
    ...
    const handleSubmitButton = async (e) => {
        ...
        const result = await axios.put("https://kba-iiti-api.vercel.app/index/edit_ssi", {id:item._id,data:editData});
    ...
    const handleDelete = async (e)=>{
        e.preventDefault();
        const result = await axios.put("https://kba-iiti-api.vercel.app/index/delete_ssi", {id:item._id});
