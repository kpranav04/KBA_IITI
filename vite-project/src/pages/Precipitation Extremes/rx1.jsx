...
function Rx1_PPT_Extreme() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const res = await axios.post('https://kba-iiti-api.vercel.app/index/rx1_post', { location: selectedOption.value,  year: cred.year, index: data.index });
    console.log(res);
  ...
  const handlegetSubmit = async (e) => {
    ...
    const response = await axios.post("https://kba-iiti-api.vercel.app/index/rx1_get", {
      year: cred.year,
    });
  ...
  const colors = [
    ...
    '#00ffb4', '#00d0ff','#3f8dfe', '#0952ff', '#0a1ec6',  ' rgb(0 13 84 / 84%)',  
  ];
        ...
        <div className="bg-white p-5 md:p-8 rounded-lg shadow-md w-full ">
          ...
          <div className="containera vxyz flex flex-col md:flex-row justify-center items-center space-y-4 md:space-y-0 md:space-x-8 mt-4 md:mt-0">
            ...
            <div className="w-full md:w-auto">
              <div className="text-lg font-bold mb-4 flex justify-center "><h2 className="text-center heading_ssi">Maximum 1-day precipitation (Rx1Day)</h2></div>
            ...
            <div className="flex flex-row container123">
              ...
              {user && (
                ...
                <h3>ADD DATA</h3>
                  ...
                  />
                  <h6 className="text-lg font-semibold mb-4">Select Rx1 :</h6>
                  <input
              ...
              <div className="get_data_box bg-gray-100 rounded-md p-4">
                <h3 className="text-lg font-semibold mb-2">Get Rx1</h3>
                <h6 className="text-lg font-semibold mb-2">Select Year :</h6>
                <select
                  className="entry w-full mb-3 p-2 border border-gray-300 rounded"
                  required
...
{colors.map((color, index) => (
  <div key={index} className="color-box-container">
    ...
    {index + 1 == 1 ? <> <span style={{fontSize:"12px",marginLeft:"-3.5px"}} 
    className="color-index">Less than 2.4</span></> : <></>}
    {index + 1 == 2 ? <> <span style={{fontSize:"12px",marginLeft:"-3.5px"}} className="color-index">  2-4 - 15.5</span></> : <></>}
    {index + 1 == 3 ? <> <span style={{fontSize:"12px",marginLeft:"-3.5px"}} className="color-index">15.6 - 64.4</span></> : <></>}
    {index + 1 == 4 ? <> <span style={{fontSize:"12px",marginLeft:"-3.5px"}} className="color-index">64.5 - 115.5</span></> : <></>}
    {index + 1 == 5 ? <> <span style={{fontSize:"12px",marginLeft:"-3.5px"}} className="color-index">115.5 - 204.4</span></> : <></>}
    {index + 1 == 6 ? <> <span style={{fontSize:"12px",marginLeft:"-3.5px"}} className="color-index">More than 204.5</span></> : <></>}
...
export default Rx1_PPT_Extreme;
