...
function MyMap_Rx1({dataArray}) {
  ...
  const getColor = (index) => {
    ...
    if ( index <= 2.4) return  '#00ffb4';
    if (index >= 2.5 && index < 15.5) return '#00d0ff';
    if (index >= 15.6 && index <= 64.4) return  '#3f8dfe';
    if (index >= 64.5 && index <= 115.5) return  '#0952ff';
    if (index >= 115.6 && index <= 204.4) return  '#0a1ec6';
    if (index >= 204.5) return  ' rgb(0 13 84 / 84%)';
