...
function R95_PPT_Extreme() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const res = await axios.post('https://kba-iiti-1.onrender.com/index/r95_post', { location: selectedOption.value,  year: cred.year, index: data.index });
    console.log(res);
  ...
  const handlegetSubmit = async (e) => {
    ...
    const response = await axios.post("https://kba-iiti-1.onrender.com/index/r95_get", {
      year: cred.year,
    });
