...
function R95_PPT_Extreme() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const res = await axios.post('http://localhost:3000/index/r95_post', { location: selectedOption.value,  year: cred.year, index: data.index });
    console.log(res);
  ...
  const handlegetSubmit = async (e) => {
    ...
    const response = await axios.post("http://localhost:3000/index/r95_get", {
      year: cred.year,
    });
